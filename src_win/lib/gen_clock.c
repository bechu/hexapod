...
#define CLOCK_INT_PENDING bit_is_set(TIFR5,OCF5A)		
#define CLOCK_INT_CLEAR sbi(TIFR5,OCF5A)		
		
#define CLOCK_INT_ENABLE sbi(TIMSK5,OCIE5A)		
#define CLOCK_INT_DISABLE cbi(TIMSK5,OCIE5A)		
		
#define CLOCK_TOP_REG OCR5A
#include <errors.h>		
