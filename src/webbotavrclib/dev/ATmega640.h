...
#ifdef PORTA
// Define Port A
	const IOPort PROGMEM _PORTA={_SFR_MEM_ADDR(PORTA),_SFR_MEM_ADDR(DDRA),_SFR_MEM_ADDR(PINA)};
# ifdef PA0
	const IOPin PROGMEM _A0 = { &_PORTA, BV(PA0)};
#	define A0 &_A0
#	undef PA0
# endif
# ifdef PA1
	const IOPin PROGMEM _A1 = { &_PORTA, BV(PA1)};
#	define A1 &_A1
#	undef PA1
# endif
# ifdef PA2
	const IOPin PROGMEM _A2 = { &_PORTA, BV(PA2)};
#	define A2 &_A2
#	undef PA2
# endif
# ifdef PA3
	const IOPin PROGMEM _A3 = { &_PORTA, BV(PA3)};
#	define A3 &_A3
#	undef PA3
# endif
# ifdef PA4
	const IOPin PROGMEM _A4 = { &_PORTA, BV(PA4)};
#	define A4 &_A4
#	undef PA4
# endif
# ifdef PA5
	const IOPin PROGMEM _A5 = { &_PORTA, BV(PA5)};
#	define A5 &_A5
#	undef PA5
# endif
# ifdef PA6
	const IOPin PROGMEM _A6 = { &_PORTA, BV(PA6)};
#	define A6 &_A6
#	undef PA6
# endif
# ifdef PA7
	const IOPin PROGMEM _A7 = { &_PORTA, BV(PA7)};
#	define A7 &_A7
#	undef PA7
# endif
...
#ifdef PORTB
// Define Port B
	const IOPort PROGMEM _PORTB={_SFR_MEM_ADDR(PORTB),_SFR_MEM_ADDR(DDRB),_SFR_MEM_ADDR(PINB)};
# ifdef PB0
	const IOPin PROGMEM _B0 = { &_PORTB, BV(PB0)};
#	define B0 &_B0
#	undef PB0
# endif
# ifdef PB1
	const IOPin PROGMEM _B1 = { &_PORTB, BV(PB1)};
#	define B1 &_B1
#	undef PB1
# endif
# ifdef PB2
	const IOPin PROGMEM _B2 = { &_PORTB, BV(PB2)};
#	define B2 &_B2
#	undef PB2
# endif
# ifdef PB3
	const IOPin PROGMEM _B3 = { &_PORTB, BV(PB3)};
#	define B3 &_B3
#	undef PB3
# endif
# ifdef PB4
	const IOPin PROGMEM _B4 = { &_PORTB, BV(PB4)};
#	define B4 &_B4
#	undef PB4
# endif
# ifdef PB5
	const IOPin PROGMEM _B5 = { &_PORTB, BV(PB5)};
#	define B5 &_B5
#	undef PB5
# endif
# ifdef PB6
	const IOPin PROGMEM _B6 = { &_PORTB, BV(PB6)};
#	define B6 &_B6
#	undef PB6
# endif
# ifdef PB7
	const IOPin PROGMEM _B7 = { &_PORTB, BV(PB7)};
#	define B7 &_B7
#	undef PB7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTC
// Define Port C
	const IOPort PROGMEM _PORTC={_SFR_MEM_ADDR(PORTC),_SFR_MEM_ADDR(DDRC),_SFR_MEM_ADDR(PINC)};
# ifdef PC0
	const IOPin PROGMEM _C0 = { &_PORTC, BV(PC0)};
#	define C0 &_C0
#	undef PC0
# endif
# ifdef PC1
	const IOPin PROGMEM _C1 = { &_PORTC, BV(PC1)};
#	define C1 &_C1
#	undef PC1
# endif
# ifdef PC2
	const IOPin PROGMEM _C2 = { &_PORTC, BV(PC2)};
#	define C2 &_C2
#	undef PC2
# endif
# ifdef PC3
	const IOPin PROGMEM _C3 = { &_PORTC, BV(PC3)};
#	define C3 &_C3
#	undef PC3
# endif
# ifdef PC4
	const IOPin PROGMEM _C4 = { &_PORTC, BV(PC4)};
#	define C4 &_C4
#	undef PC4
# endif
# ifdef PC5
	const IOPin PROGMEM _C5 = { &_PORTC, BV(PC5)};
#	define C5 &_C5
#	undef PC5
# endif
# ifdef PC6
	const IOPin PROGMEM _C6 = { &_PORTC, BV(PC6)};
#	define C6 &_C6
#	undef PC6
# endif
# ifdef PC7
	const IOPin PROGMEM _C7 = { &_PORTC, BV(PC7)};
#	define C7 &_C7
#	undef PC7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTD
// Define Port D
	const IOPort PROGMEM _PORTD={_SFR_MEM_ADDR(PORTD),_SFR_MEM_ADDR(DDRD),_SFR_MEM_ADDR(PIND)};
# ifdef PD0
	const IOPin PROGMEM _D0 = { &_PORTD, BV(PD0)};
#	define D0 &_D0
#	undef PD0
# endif
# ifdef PD1
	const IOPin PROGMEM _D1 = { &_PORTD, BV(PD1)};
#	define D1 &_D1
#	undef PD1
# endif
# ifdef PD2
	const IOPin PROGMEM _D2 = { &_PORTD, BV(PD2)};
#	define D2 &_D2
#	undef PD2
# endif
# ifdef PD3
	const IOPin PROGMEM _D3 = { &_PORTD, BV(PD3)};
#	define D3 &_D3
#	undef PD3
# endif
# ifdef PD4
	const IOPin PROGMEM _D4 = { &_PORTD, BV(PD4)};
#	define D4 &_D4
#	undef PD4
# endif
# ifdef PD5
	const IOPin PROGMEM _D5 = { &_PORTD, BV(PD5)};
#	define D5 &_D5
#	undef PD5
# endif
# ifdef PD6
	const IOPin PROGMEM _D6 = { &_PORTD, BV(PD6)};
#	define D6 &_D6
#	undef PD6
# endif
# ifdef PD7
	const IOPin PROGMEM _D7 = { &_PORTD, BV(PD7)};
#	define D7 &_D7
#	undef PD7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTE
// Define Port E
	const IOPort PROGMEM _PORTE={_SFR_MEM_ADDR(PORTE),_SFR_MEM_ADDR(DDRE),_SFR_MEM_ADDR(PINE)};
# ifdef PE0
	const IOPin PROGMEM _E0 = { &_PORTE, BV(PE0)};
#	define E0 &_E0
#	undef PE0
# endif
# ifdef PE1
	const IOPin PROGMEM _E1 = { &_PORTE, BV(PE1)};
#	define E1 &_E1
#	undef PE1
# endif
# ifdef PE2
	const IOPin PROGMEM _E2 = { &_PORTE, BV(PE2)};
#	define E2 &_E2
#	undef PE2
# endif
# ifdef PE3
	const IOPin PROGMEM _E3 = { &_PORTE, BV(PE3)};
#	define E3 &_E3
#	undef PE3
# endif
# ifdef PE4
	const IOPin PROGMEM _E4 = { &_PORTE, BV(PE4)};
#	define E4 &_E4
#	undef PE4
# endif
# ifdef PE5
	const IOPin PROGMEM _E5 = { &_PORTE, BV(PE5)};
#	define E5 &_E5
#	undef PE5
# endif
# ifdef PE6
	const IOPin PROGMEM _E6 = { &_PORTE, BV(PE6)};
#	define E6 &_E6
#	undef PE6
# endif
# ifdef PE7
	const IOPin PROGMEM _E7 = { &_PORTE, BV(PE7)};
#	define E7 &_E7
#	undef PE7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTF
// Define Port F
	const IOPort PROGMEM _PORTF={_SFR_MEM_ADDR(PORTF),_SFR_MEM_ADDR(DDRF),_SFR_MEM_ADDR(PINF)};
# ifdef PF0
	const IOPin PROGMEM _F0 = { &_PORTF, BV(PF0)};
#	define F0 &_F0
#	undef PF0
# endif
# ifdef PF1
	const IOPin PROGMEM _F1 = { &_PORTF, BV(PF1)};
#	define F1 &_F1
#	undef PF1
# endif
# ifdef PF2
	const IOPin PROGMEM _F2 = { &_PORTF, BV(PF2)};
#	define F2 &_F2
#	undef PF2
# endif
# ifdef PF3
	const IOPin PROGMEM _F3 = { &_PORTF, BV(PF3)};
#	define F3 &_F3
#	undef PF3
# endif
# ifdef PF4
	const IOPin PROGMEM _F4 = { &_PORTF, BV(PF4)};
#	define F4 &_F4
#	undef PF4
# endif
# ifdef PF5
	const IOPin PROGMEM _F5 = { &_PORTF, BV(PF5)};
#	define F5 &_F5
#	undef PF5
# endif
# ifdef PF6
	const IOPin PROGMEM _F6 = { &_PORTF, BV(PF6)};
#	define F6 &_F6
#	undef PF6
# endif
# ifdef PF7
	const IOPin PROGMEM _F7 = { &_PORTF, BV(PF7)};
#	define F7 &_F7
#	undef PF7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTG
// Define Port G
	const IOPort PROGMEM _PORTG={_SFR_MEM_ADDR(PORTG),_SFR_MEM_ADDR(DDRG),_SFR_MEM_ADDR(PING)};
# ifdef PG0
	const IOPin PROGMEM _G0 = { &_PORTG, BV(PG0)};
#	define G0 &_G0
#	undef PG0
# endif
# ifdef PG1
	const IOPin PROGMEM _G1 = { &_PORTG, BV(PG1)};
#	define G1 &_G1
#	undef PG1
# endif
# ifdef PG2
	const IOPin PROGMEM _G2 = { &_PORTG, BV(PG2)};
#	define G2 &_G2
#	undef PG2
# endif
# ifdef PG3
	const IOPin PROGMEM _G3 = { &_PORTG, BV(PG3)};
#	define G3 &_G3
#	undef PG3
# endif
# ifdef PG4
	const IOPin PROGMEM _G4 = { &_PORTG, BV(PG4)};
#	define G4 &_G4
#	undef PG4
# endif
# ifdef PG5
	const IOPin PROGMEM _G5 = { &_PORTG, BV(PG5)};
#	define G5 &_G5
#	undef PG5
# endif
# ifdef PG6
	const IOPin PROGMEM _G6 = { &_PORTG, BV(PG6)};
#	define G6 &_G6
#	undef PG6
# endif
# ifdef PG7
	const IOPin PROGMEM _G7 = { &_PORTG, BV(PG7)};
#	define G7 &_G7
#	undef PG7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTH
// Define Port H
	const IOPort PROGMEM _PORTH={_SFR_MEM_ADDR(PORTH),_SFR_MEM_ADDR(DDRH),_SFR_MEM_ADDR(PINH)};
# ifdef PH0
	const IOPin PROGMEM _H0 = { &_PORTH, BV(PH0)};
#	define H0 &_H0
#	undef PH0
# endif
# ifdef PH1
	const IOPin PROGMEM _H1 = { &_PORTH, BV(PH1)};
#	define H1 &_H1
#	undef PH1
# endif
# ifdef PH2
	const IOPin PROGMEM _H2 = { &_PORTH, BV(PH2)};
#	define H2 &_H2
#	undef PH2
# endif
# ifdef PH3
	const IOPin PROGMEM _H3 = { &_PORTH, BV(PH3)};
#	define H3 &_H3
#	undef PH3
# endif
# ifdef PH4
	const IOPin PROGMEM _H4 = { &_PORTH, BV(PH4)};
#	define H4 &_H4
#	undef PH4
# endif
# ifdef PH5
	const IOPin PROGMEM _H5 = { &_PORTH, BV(PH5)};
#	define H5 &_H5
#	undef PH5
# endif
# ifdef PH6
	const IOPin PROGMEM _H6 = { &_PORTH, BV(PH6)};
#	define H6 &_H6
#	undef PH6
# endif
# ifdef PH7
	const IOPin PROGMEM _H7 = { &_PORTH, BV(PH7)};
#	define H7 &_H7
#	undef PH7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTJ
// Define Port J
	const IOPort PROGMEM _PORTJ={_SFR_MEM_ADDR(PORTJ),_SFR_MEM_ADDR(DDRJ),_SFR_MEM_ADDR(PINJ)};
# ifdef PJ0
	const IOPin PROGMEM _J0 = { &_PORTJ, BV(PJ0)};
#	define J0 &_J0
#	undef PJ0
# endif
# ifdef PJ1
	const IOPin PROGMEM _J1 = { &_PORTJ, BV(PJ1)};
#	define J1 &_J1
#	undef PJ1
# endif
# ifdef PJ2
	const IOPin PROGMEM _J2 = { &_PORTJ, BV(PJ2)};
#	define J2 &_J2
#	undef PJ2
# endif
# ifdef PJ3
	const IOPin PROGMEM _J3 = { &_PORTJ, BV(PJ3)};
#	define J3 &_J3
#	undef PJ3
# endif
# ifdef PJ4
	const IOPin PROGMEM _J4 = { &_PORTJ, BV(PJ4)};
#	define J4 &_J4
#	undef PJ4
# endif
# ifdef PJ5
	const IOPin PROGMEM _J5 = { &_PORTJ, BV(PJ5)};
#	define J5 &_J5
#	undef PJ5
# endif
# ifdef PJ6
	const IOPin PROGMEM _J6 = { &_PORTJ, BV(PJ6)};
#	define J6 &_J6
#	undef PJ6
# endif
# ifdef PJ7
	const IOPin PROGMEM _J7 = { &_PORTJ, BV(PJ7)};
#	define J7 &_J7
#	undef PJ7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTK
// Define Port K
	const IOPort PROGMEM _PORTK={_SFR_MEM_ADDR(PORTK),_SFR_MEM_ADDR(DDRK),_SFR_MEM_ADDR(PINK)};
# ifdef PK0
	const IOPin PROGMEM _K0 = { &_PORTK, BV(PK0)};
#	define K0 &_K0
#	undef PK0
# endif
# ifdef PK1
	const IOPin PROGMEM _K1 = { &_PORTK, BV(PK1)};
#	define K1 &_K1
#	undef PK1
# endif
# ifdef PK2
	const IOPin PROGMEM _K2 = { &_PORTK, BV(PK2)};
#	define K2 &_K2
#	undef PK2
# endif
# ifdef PK3
	const IOPin PROGMEM _K3 = { &_PORTK, BV(PK3)};
#	define K3 &_K3
#	undef PK3
# endif
# ifdef PK4
	const IOPin PROGMEM _K4 = { &_PORTK, BV(PK4)};
#	define K4 &_K4
#	undef PK4
# endif
# ifdef PK5
	const IOPin PROGMEM _K5 = { &_PORTK, BV(PK5)};
#	define K5 &_K5
#	undef PK5
# endif
# ifdef PK6
	const IOPin PROGMEM _K6 = { &_PORTK, BV(PK6)};
#	define K6 &_K6
#	undef PK6
# endif
# ifdef PK7
	const IOPin PROGMEM _K7 = { &_PORTK, BV(PK7)};
#	define K7 &_K7
#	undef PK7
# endif
//undefine pins to stop them being used directly
...
#ifdef PORTL
// Define Port L
	const IOPort PROGMEM _PORTL={_SFR_MEM_ADDR(PORTL),_SFR_MEM_ADDR(DDRL),_SFR_MEM_ADDR(PINL)};
# ifdef PL0
	const IOPin PROGMEM _L0 = { &_PORTL, BV(PL0)};
#	define L0 &_L0
#	undef PL0
# endif
# ifdef PL1
	const IOPin PROGMEM _L1 = { &_PORTL, BV(PL1)};
#	define L1 &_L1
#	undef PL1
# endif
# ifdef PL2
	const IOPin PROGMEM _L2 = { &_PORTL, BV(PL2)};
#	define L2 &_L2
#	undef PL2
# endif
# ifdef PL3
	const IOPin PROGMEM _L3 = { &_PORTL, BV(PL3)};
#	define L3 &_L3
#	undef PL3
# endif
# ifdef PL4
	const IOPin PROGMEM _L4 = { &_PORTL, BV(PL4)};
#	define L4 &_L4
#	undef PL4
# endif
# ifdef PL5
	const IOPin PROGMEM _L5 = { &_PORTL, BV(PL5)};
#	define L5 &_L5
#	undef PL5
# endif
# ifdef PL6
	const IOPin PROGMEM _L6 = { &_PORTL, BV(PL6)};
#	define L6 &_L6
#	undef PL6
# endif
# ifdef PL7
	const IOPin PROGMEM _L7 = { &_PORTL, BV(PL7)};
#	define L7 &_L7
#	undef PL7
# endif
//undefine pins to stop them being used directly
